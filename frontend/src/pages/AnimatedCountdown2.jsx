...
function AnimatedCountdown2({ insertedDate, dueDate }) {
  ...
  return (
   ...
   <span className={countdownData.expired ? "expired-countdown" : "live-countdown" }style={{ fontSize: '16px' }}>
      {countdownData.days} Day {countdownData.hours} Hour {countdownData.minutes} Min {countdownData.seconds} Sec
    </span>
...
export default AnimatedCountdown2;
